...
import { GET_LOAD_MORE_NEWS } from "./get-load-more-news";
...
//  NOTE: The useLazyQuery hook is perfect for executing queries in
//        response to events besides component rendering. Unlike with
//        useQuery, when you call useLazyQuery, it does not immediately
//        execute its associated query. Instead, it returns a query
//        function in its result tuple that you call whenever you're
